...
class _DrinksScreenState extends State<DrinksScreen> {
  ...
  late List<ImageProvider> _drinkImages;  // Cache the drink images
  ...
  Future<void> _loadData() async {
    ...
    setState(() {
      ...
      authorised = user.userRoles![0].role!.roleName == "Menedzer" || user.userRoles![0].role!.roleName == "Kuhar";
      
      // Pre-cache the drink images
      _drinkImages = resultD!.result.map((drink) {
        if (drink.drinkImage != null && drink.drinkImage!.isNotEmpty) {
          final image = Image.memory(base64Decode(drink.drinkImage!));
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (resultD != null && index < resultD!.result.length) {
                            ...
                            return _foodCardBuilder(drink, _drinkImages[index]);
                          } else {
  ...
  Widget _foodCardBuilder(Drink drink, ImageProvider image) {
    return MouseRegion(
